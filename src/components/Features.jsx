        ...
        <div className="relative size-full">
            ...
            <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
                <div className="">
                    ...
                    {description && (
                        <div className="mt-3 max-w-64 text-xs md:text-base">{description}</div>
                    )}
                </div>
            </div>
        </div>
                ...
                <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                    ...
                    <BentoTilt className="bento-tilt_2">
                        <div className="flex size-full flex-col justify-between bg-violet-700 p-5">
                            <h1 className="bento-title font-zentry special-font max-w-64 text-black">M<b>o</b>re co<b>m</b>ing s<b>o</b>on!</h1>
